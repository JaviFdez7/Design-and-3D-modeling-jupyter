...
def dibujar_superficie_parametrica(S,a,b,c,d,col):
    ...
    return parametric_plot3d((lambda u,v: S(u,v)[0,0],lambda u,v: S(u,v)[1,0],lambda u,v: S(u,v)[2,0]), (a,b), (c,d), opacity = 
    0.8,color=col) 
